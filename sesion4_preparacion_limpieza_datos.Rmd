...
```{r}
datos_hospital_reemplazo <- datos_hospital |> 
  ...
  mutate(chills = case_when(chills == "yes" ~ "si",
                                  TRUE ~ chills),
         
                        cough =case_when(cough == "yes" ~ "si",
                                  TRUE ~ cough),
                       aches= case_when( aches == "yes" ~ "si",
                                  TRUE ~ aches),
                        vomit=case_when( vomit == "yes" ~ "si",
                                  TRUE ~ vomit))
```
